...
// node_modules/@dmuy/timepicker/dist/mdtimepicker.js
var require_mdtimepicker = __commonJS({
  "node_modules/@dmuy/timepicker/dist/mdtimepicker.js"(exports, module) {
    (function(global2, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, global2.mdtimepicker = factory());
    })(exports, function() {
      "use strict";
      ...
      var ordinaryToPrimitive$1 = function(input, pref) {
        var fn, val;
        if (pref === "string" && isCallable$e(fn = input.toString) && !isObject$8(val = call$e(fn, input)))
          return val;
        if (isCallable$e(fn = input.valueOf) && !isObject$8(val = call$e(fn, input)))
          return val;
        if (pref !== "string" && isCallable$e(fn = input.toString) && !isObject$8(val = call$e(fn, input)))
          return val;
      ...
      var defineGlobalProperty$3 = function(key, value) {
        try {
          defineProperty$2(global$c, key, { value, configurable: true, writable: true });
        } catch (error) {
          global$c[key] = value;
        }
        return value;
      ...
      objectGetOwnPropertyDescriptor.f = DESCRIPTORS$6 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor2(O, P) {
        ...
        if (hasOwn$8(O, P))
          return createPropertyDescriptor$3(!call$c(propertyIsEnumerableModule.f, O, P), O[P]);
      };
      ...
      var objectKeysInternal = function(object, names) {
        ...
        var key;
        for (key in O)
          !hasOwn$4(hiddenKeys$2, key) && hasOwn$4(O, key) && push$2(result, key);
      ...
      var ownKeys$1 = getBuiltIn$4("Reflect", "ownKeys") || function ownKeys2(it) {
        var keys2 = getOwnPropertyNamesModule.f(anObject$d(it));
      ...
      var classof$6 = TO_STRING_TAG_SUPPORT$2 ? classofRaw$1 : function(it) {
        var O, tag, result;
        return it === void 0 ? "Undefined" : it === null ? "Null" : typeof (tag = tryGet(O = $Object$1(it), TO_STRING_TAG$2)) == "string" ? tag : CORRECT_ARGUMENTS ? classofRaw$1(O) : (result = classofRaw$1(O)) == "Object" && isCallable$8(O.callee) ? "Arguments" : result;
      };
      ...
      var fixRegexpWellKnownSymbolLogic = function(KEY, exec2, FORCED2, SHAM) {
        ...
        if (SHAM)
          createNonEnumerableProperty$3(RegExpPrototype[SYMBOL], "sham", true);
      };
      ...
      var createMethod$2 = function(CONVERT_TO_STRING) {
        return function($this, pos) {
          ...
          return first < 55296 || first > 56319 || position + 1 === size || (second = charCodeAt(S, position + 1)) < 56320 || second > 57343 ? CONVERT_TO_STRING ? charAt$3(S, position) : first : CONVERT_TO_STRING ? stringSlice$2(S, position, position + 2) : (first - 55296 << 10) + (second - 56320) + 65536;
        };
      };
      var stringMultibyte = {
      ...
      var regexpExecAbstract = function(R, S) {
        ...
        if (isCallable$7(exec2)) {
          var result = call$a(exec2, R, S);
          if (result !== null)
            anObject$9(result);
          return result;
        }
        if (classof$4(R) === "RegExp")
          return call$a(regexpExec, R, S);
      ...
      fixRegExpWellKnownSymbolLogic$1("match", function(MATCH, nativeMatch, maybeCallNative) {
        return [
          ...
          function match2(regexp) {
            ...
            var matcher = isNullOrUndefined$2(regexp) ? void 0 : getMethod$4(regexp, MATCH);
      ...
      fixRegExpWellKnownSymbolLogic("replace", function(_, nativeReplace2, maybeCallNative) {
        ...
        return [
          ...
          function replace2(searchValue, replaceValue) {
            ...
            var replacer = isNullOrUndefined$1(searchValue) ? void 0 : getMethod$3(searchValue, REPLACE);
            return replacer ? call$7(replacer, searchValue, O, replaceValue) : call$7(nativeReplace2, toString$2(O), searchValue, replaceValue);
          },
      ...
      var doesNotExceedSafeInteger$1 = function(it) {
        if (it > MAX_SAFE_INTEGER)
          throw $TypeError$4("Maximum allowed index exceeded");
        return it;
      };
      ...
      var createMethod$1 = function(TYPE) {
        ...
        return function(object, fn, target) {
          ...
          var Promise2 = getBuiltIn$1("Promise");
          ...
          return new Promise2(function(resolve, reject) {
            ...
            var loop = function() {
              try {
                ...
                Promise2.resolve(anObject$6(call$5(next, iterator))).then(function(step) {
                  try {
      ...
      if ([].keys) {
        ...
        if (!("next" in arrayIterator))
          ...
          if (PrototypeOfArrayIteratorPrototype !== Object.prototype)
            IteratorPrototype$3 = PrototypeOfArrayIteratorPrototype;
        }
      }
      var NEW_ITERATOR_PROTOTYPE = !isObject$2(IteratorPrototype$3) || fails$4(function() {
        var test2 = {};
        return IteratorPrototype$3[ITERATOR$4].call(test2) !== test2;
      });
      ...
      var FORCED = !isCallable$3(NativeIterator) || NativeIterator.prototype !== IteratorPrototype$2 || !fails$3(function() {
        NativeIterator({});
      });
      ...
      var isArrayIteratorMethod$2 = function(it) {
        return it !== void 0 && (Iterators$3.Array === it || ArrayPrototype[ITERATOR$3] === it);
      };
      ...
      var getIteratorMethod$3 = function(it) {
        if (!isNullOrUndefined(it))
          return getMethod$1(it, ITERATOR$2) || getMethod$1(it, "@@iterator") || Iterators$2[classof$2(it)];
      };
      ...
      var getIterator$2 = function(argument, usingIterator) {
        ...
        if (aCallable$2(iteratorMethod))
          return anObject$5(call$4(iteratorMethod, argument));
      ...
      var arraySpeciesConstructor$1 = function(originalArray) {
        ...
        if (isArray$1(originalArray)) {
          ...
          if (isConstructor$2(C) && (C === $Array$2 || isArray$1(C.prototype)))
            C = void 0;
      ...
      var callWithSafeIterationClosing$1 = function(iterator, fn, value, ENTRIES2) {
        try {
          return ENTRIES2 ? fn(anObject$1(value)[0], value[1]) : fn(value);
        } catch (error) {
      ...
      var iteratorCreateConstructor = function(IteratorConstructor2, NAME, next, ENUMERABLE_NEXT) {
        var TO_STRING_TAG2 = NAME + " Iterator";
        IteratorConstructor2.prototype = create(IteratorPrototype$1, { next: createPropertyDescriptor(+!ENUMERABLE_NEXT, next) });
        setToStringTag$1(IteratorConstructor2, TO_STRING_TAG2, false);
      ...
      var iteratorDefine = function(Iterable, NAME, IteratorConstructor2, next, DEFAULT, IS_SET, FORCED2) {
        createIteratorConstructor(IteratorConstructor2, NAME, next);
      ...
      var hf = {
        ...
        appendTo: function appendTo(elem, to, idx) {
          if (Array.isArray(elem)) {
            elem.forEach(function(el) {
              if (idx === 0)
                to.insertBefore(el, to.childNodes[idx] || null);
              else
                to.appendChild(el);
            });
          } else {
            if (idx === 0)
              to.insertBefore(elem, to.childNodes[idx] || null);
            else
              to.appendChild(elem);
          }
        },
        ...
        addEvent: function addEvent(elem, event, handler) {
          ...
          if (Array.isArray(elem)) {
            ...
            listenEvent(elem, event, handler);
        },
        /**
        ...
        removeEvent: function removeEvent(elem, event, handler) {
          ...
          if (Array.isArray(elem)) {
            ...
            delEvent(elem, event, handler);
        },
        /**
         * Removes child nodes
         * @param {Element} elem Html element to empty
         */
        empty: function empty2(elem) {
        ...
        */
            ...
            for (var prop in obj2) {
              if (Object.prototype.hasOwnProperty.call(obj2, prop)) {
                if (deep && Object.prototype.toString.call(obj2[prop]) === "[object Object]") {
                  extended[prop] = hf.extend(true, extended[prop], obj2[prop]);
                } else {
         ...
         */
        triggerChange: function triggerChange(el, data2) {
          ...
          function CustomEvent(data3) {
            var changeEvt = document.createEvent("CustomEvent");
            changeEvt.initCustomEvent("datechanged", false, false, null);
            changeEvt.data = data3;
            return changeEvt;
          }
          el.dispatchEvent(new CustomEvent(data2));
        }
      };
      var Time = function() {
        function Time2(hour, minute) {
        ...
        _createClass(Time2, [{
          ...
          value: function format(_format, hourPadding) {
            var that = this, is24Hour = (_format.match(/h/g) || []).length > 1;
      ...
      var MDTimePicker = function() {
        function MDTimePicker2(el, config) {
          _classCallCheck(this, MDTimePicker2);
          var _ = this;
          this.visible = false;
        ...
        _createClass(MDTimePicker2, [{
          key: "_setup",
          value: function _setup() {
            var _ = this, picker = _.timepicker, overlay = picker.overlay, wrapper = picker.wrapper, time = picker.timeHolder, clock = picker.clockHolder;
            hf.appendTo([time.hour, time.dots, time.minute], time.wrapper);
            hf.appendTo(time.wrapper, wrapper);
            if (!_.config.is24hour)
              hf.appendTo(time.am_pm, time.wrapper);
            var _hours = _.config.is24hour ? 24 : 12;
            for (var i = 0; i < _hours; i++) {
              var value = i + 1, deg = (HOUR_START_DEG + i * HOUR_DEG_INCR) % END_DEG - (_.config.is24hour && value < 13 ? 15 : 0), is24 = value === 24, hour = hf.createElem("div", {
              ...
              if (_.config.is24hour && value < 13)
                hour.classList.add("inner--digit");
              hf.addEvent(hourInner, "click", function() {
                var _hour = parseInt(this.parentNode.dataset.hour), _selectedT = _.selected.getPeriod(), _value = _.config.is24hour ? _hour : (_hour + (_selectedT === "PM" && _hour < 12 || _selectedT === "AM" && _hour === 12 ? 12 : 0)) % 24, disabled = _.isDisabled(_value, 0, true);
                if (disabled)
                  return;
                _.setHour(_value);
                _._switchView("minutes");
            ...
            for (var _i = 0; _i < 60; _i++) {
              var min2 = _i < 10 ? "0" + _i : _i, _deg = (MIN_START_DEG + _i * MIN_DEG_INCR) % END_DEG, minute = hf.createElem("div", {
              ...
              if (_i % 5 === 0) {
                ...
                minuteInner.innerText = min2;
              }
              hf.addEvent(minuteInner, "click", function() {
                var _minute = parseInt(this.parentNode.dataset.minute), _hour = _.selected.getHour(), disabled = _.isDisabled(_hour, _minute, true);
                if (disabled)
                  return;
                _.setMinute(_minute);
              });
          ...
          value: function _setDisabled(view) {
            ...
            if (view === "hours") {
              clock.hours.querySelectorAll(".mdtp__digit").forEach(function(hour) {
                var value = parseInt(hour.dataset.hour), period = _.selected.getPeriod(), time = new Time(value, 0);
            ...
            if (view === "minutes") {
              clock.minutes.querySelectorAll(".mdtp__digit").forEach(function(minute) {
                var value = parseInt(minute.dataset.minute), hour = _.selected.getHour(), disabled = _.isDisabled(hour, value, true);
          ...
          value: function isDisabled(hour, minute, renderMode) {
            var _ = this, minT = null, min2 = null, maxT = null, max2 = null, now = /* @__PURE__ */ new Date(), time = new Date(now.getFullYear(), now.getMonth(), now.getDate(), hour, minute, 0, 0), hourView = _.activeView === "hours";
            if (_.minTime)
              minT = _.minTime === "now" ? _.getSystemTime() : _.parseTime(_.minTime);
            if (_.maxTime)
              maxT = _.maxTime === "now" ? _.getSystemTime() : _.parseTime(_.maxTime);
            if (minT) {
              min2 = new Date(now.getFullYear(), now.getMonth(), now.getDate(), minT.getHour(), hourView && renderMode ? 0 : minT.getMinutes(), 0, 0);
            }
            if (maxT) {
              max2 = new Date(now.getFullYear(), now.getMonth(), now.getDate(), maxT.getHour(), hourView && renderMode ? 0 : maxT.getMinutes(), 0, 0);
            }
            return min2 && time < min2 || max2 && time > max2;
          }
          /**
          ...
          value: function getFormattedTime() {
            var time = this.time.format(this.config.timeFormat, false), tValue = this.time.format(this.config.format, this.config.hourPadding);
            return {
              time,
              value: tValue
            };
          ...
          value: function parseTime(time, tf) {
            var that = this, format = typeof tf === "undefined" ? that.config.format : tf, hLength = (format.match(/h/g) || []).length, is24Hour = hLength > 1, tLength = (format.match(/t/g) || []).length, timeLength = time.length, fH = format.indexOf("h"), lH = format.lastIndexOf("h"), hour = "", min2 = "", t = "";
            ...
            var fM = format.indexOf("m"), lM = format.lastIndexOf("m"), fT = format.indexOf("t");
            var prevM = format.substring(fM - 1, fM);
            format.substring(lM + 1, lM + 2);
            if (lM === format.length - 1) {
              min2 = time.substring(time.indexOf(prevM, fM - 1) + 1, timeLength);
            } else if (fM === 0) {
              min2 = time.substring(0, 2);
            } else {
              min2 = time.substr(fM, 2);
            }
            if (is24Hour)
              t = parseInt(hour) > 11 ? tLength > 1 ? "PM" : "pm" : tLength > 1 ? "AM" : "am";
            else
              t = time.substr(fT, 2);
            var isPm = t.toLowerCase() === "pm", outTime = new Time(parseInt(hour), parseInt(min2));
          ...
          key: "_triggerChange",
          value: function _triggerChange(data2) {
            hf.triggerChange(this.input, data2);
            if (this.config.events && this.config.events.timeChanged)
              this.config.events.timeChanged.call(this, data2, this);
          }
        }]);
        return MDTimePicker2;
      }();
      _defineProperty(MDTimePicker, "default_configs", null);
      function mdtimepicker() {
        var args = arguments, arg0 = args[0], arg0IsList = arg0 instanceof NodeList || Array.isArray(arg0), arg0IsElem = arg0 instanceof Element, inputs = typeof arg0 === "string" ? document.querySelectorAll(arg0) : arg0IsList ? arg0 : arg0IsElem ? [arg0] : document.querySelectorAll(DEFAULT_CLASS), options = _typeof(arg0) === "object" && !arg0IsList && !arg0IsElem ? arg0 : args[1] && _typeof(args[1]) === "object" ? args[1] : {}, _defaults = hf.extend({}, MDTimePicker.default_configs || DEFAULTS);
        if (options && options.is24hour)
          _defaults.format = "hh:mm";
...
export default require_mdtimepicker();
/*! Bundled license information:

@dmuy/timepicker/dist/mdtimepicker.js:
  (*!DO NOT REMOVE!
   ...
   *)
*/
//# sourceMappingURL=@dmuy_timepicker.js.map
