        ...
        <table class="fl-table" >
            ...
            @foreach ($patient->patientRecord as $patientRecords)
                <tr >
                        ...
                        <td>{{$patient->email}}</td>
                        <td>
                            <button  type="button" data-toggle="modal" data-target="#viewPatient-{{$patientRecords}}" data-backdrop="static" data-keyboard="false">
            View
            </button>   
                        <!-- View Modal -->
                        <div class="modal fade" id="viewPatient-{{$patientRecords}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">{{$patient->name}}'s Patient Record</h5>
