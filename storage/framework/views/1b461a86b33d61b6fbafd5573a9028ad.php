...
<body>
    ...
    <tr>
        <td>
            <form id="uploadForm" action="<?php echo e(route('scanner.uploadP', ['patient' => $patient])); ?>" method="post" accept="image/*" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
    ...
    <div class="content">
      <form method="post" action="<?php echo e(route('patient.store', ['patient' => $patient])); ?>" class="gridForm">
          <?php echo csrf_field(); ?>
          <?php echo method_field('post'); ?>
              ...
              <div class="grid-input name">
                ...
                <input type="text" placeholder="Enter Last Name" name="last_name" value="<?php echo e(isset($pediatrics->last_name) ? $pediatrics->last_name : ''); ?>" required />
                <input type="text" placeholder="Enter First Name" name="first_name"  value="<?php echo e(isset($pediatrics->first_name) ? $pediatrics->first_name : ''); ?>" required />
              </div>
              <div class="grid-input">
                  <label >&nbspBirth Date</label>
                  <input class=""  type="date" name="birthdate" value="<?php echo e(isset($pediatrics->birthdate) ? $pediatrics->birthdate : ''); ?>" placeholder="Enter birth date"/>
              </div>
              <div class="grid-input">
                <label  >&nbspAddress</label>
                <input class="" type="text" name="address" placeholder="Enter address"  value="<?php echo e(isset($pediatrics->address) ? $pediatrics->address : ''); ?>" required /><br>
              </div>
              <div class="grid-input">
                <label >&nbspMother's Name (Last Name, First Name)</label>
                <input class=""  type="text" name="mother_name" placeholder="Enter Name" value="<?php echo e(isset($pediatrics->mother_name) ? $pediatrics->mother_name : ''); ?>" required />
              </div>
              <div class="grid-input">
                <label>&nbspMother's Phone Number</label>
                <input class="" type="number" name="mother_phone" placeholder="Enter phone number" value="<?php echo e(isset($pediatrics->mother_phone) ? $pediatrics->mother_phone : ''); ?>" required />
              </div>
              <div class="grid-input">
                <label>&nbspFather's Name (Last Name, First Name)</label>
                <input class="" type="text" name="father_name" value="<?php echo e(isset($pediatrics->father_name) ? $pediatrics->father_name : ''); ?>" placeholder="Enter Name" required />
              </div>
              <div class="grid-input">
                <label>&nbspFather's Phone Number</label>
                <input class="" type="number" name="father_phone"  placeholder="Enter phone number" value="<?php echo e(isset($pediatrics->father_phone) ? $pediatrics->father_phone : ''); ?>" required />
              </div>
            <div class="grid-input">
                <label>Gender</label>
                <select name="sex">
                    <option value="male" <?php echo e(isset($pediatrics->sex) && $pediatrics->sex === 'male' ? 'selected' : ''); ?>>Male</option>
                    <option value="female" <?php echo e(isset($pediatrics->sex) && $pediatrics->sex === 'female' ? 'selected' : ''); ?>>Female</option>
                </select>
            </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\PatientRecord\resources\views/admin/pediatrics.blade.php ENDPATH**/ ?>