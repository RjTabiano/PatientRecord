...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" /><link rel="icon" type="" href="<?php echo e(asset('images/logocircle.png')); ?>" />
  ...
  <body>
    ...
    <div class="container">
      ...
      <form method="post" action="<?php echo e(route('patient.store', ['patient' => $patient])); ?>" class="form">
        <?php echo csrf_field(); ?>
