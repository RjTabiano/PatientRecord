...
<body>
      ...
      <div class="nav__menu" id="nav-menu">
        ...
        <?php if(Route::has('login')): ?>
            <?php if(auth()->guard()->check()): ?>
                <li class="nav__item"><a href="<?php echo e(route('services')); ?>" class="nav__link">Book Now!</a></li>
                <li class="nav__item"><a href="<?php echo e(route('profile.edit')); ?>" class="nav__link"><?php echo e(Auth::user()->name); ?></a></li>
            <?php else: ?>
                <li class="nav__item"><a href="<?php echo e(route('login')); ?>" class="nav__link">Log in</a></li>

                <?php if(Route::has('register')): ?>
                <li class="nav__item"><a href="<?php echo e(route('register')); ?>" class="nav__link">Register</a></li>
                <?php endif; ?>
            <?php endif; ?>
    <?php endif; ?>
 ...
 <body>
  <main class="l-main">
    ...
    <section class="home" id="home">
      <div class="home__container bd-grid">
        ...
        <img src="<?php echo e(asset('images/logo1.png')); ?>" alt="" class="home__img">
      </div>
    </section>
    ...
    <section class="about section" id="about">
      ...
      <div class="about__container bd-grid">
        <div class="about__img">
          <img src="<?php echo e(asset('images/place.jpg')); ?>" alt="">
        </div>
  ...
  <!--===== MAIN JS =====-->
  <script src="<?php echo e(asset('javascript/js.js')); ?>"></script>
</body>

</html><?php /**PATH C:\xampp\htdocs\PatientRecord\resources\views/welcome.blade.php ENDPATH**/ ?>